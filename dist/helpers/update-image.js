...
const updateImage = (type, id, fileName) => __awaiter(void 0, void 0, void 0, function* () {
    if (type === 'users') {
        let userAvatar;
        ...
        users_model_1.default.update({ avatar: fileName }, {
            where: {
                id
            }
        });
        ...
        hospitals_model_1.default.update({ image: fileName }, {
            where: {
                id
            }
        });
